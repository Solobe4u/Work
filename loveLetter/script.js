...
function applyConfig() {
  if (window.CONFIG) {
    // Helper to safely update HTML if the element exists
    ...
    updateHTML('subtitle', `${CONFIG.partnerName}, ${CONFIG.messages.subtitle}`);
    updateHTML('partnerName', `${CONFIG.partnerName} 💕`);
    updateHTML('partnerDescription', CONFIG.characters.partner);
    updateHTML('yourName', `${CONFIG.yourName} 💙`);
    updateHTML('yourDescription', CONFIG.characters.you);

    // Update Messages
    updateHTML('loveNoteText', `${CONFIG.partnerName}, ${CONFIG.messages.loveNote}`);
    updateHTML('specialMessageTitle', `To My Dearest ${CONFIG.partnerName}`);
    updateHTML('specialMessage1', CONFIG.messages.specialMessage);
    updateHTML('specialMessage2', CONFIG.messages.specialMessage2);
    updateHTML('signature', CONFIG.messages.signature);

    // Update Memory Descriptions
    updateHTML('memoryLateNight', CONFIG.memories.lateNight);
    updateHTML('memoryFirstMeeting', CONFIG.memories.firstMeeting);
    updateHTML('memoryCare', CONFIG.memories.care);
  }
}
...
if (window.CONFIG && window.CONFIG.kissMessages) {
    ...
    if (milestones.includes(kissCount) && window.CONFIG.kissMessages[kissCount]) {
        showSpecialMessage(window.CONFIG.kissMessages[kissCount]);
    }
}
        ...
        // if (window.CONFIG && window.CONFIG.kissMessages) {
        //     if (kissCount === 2 && window.CONFIG.kissMessages[10]) {
        //         showSpecialMessage(window.CONFIG.kissMessages[10]);
        //     } else if (kissCount === 4 && window.CONFIG.kissMessages[50]) {
        //         showSpecialMessage(window.CONFIG.kissMessages[4]);
        //     } else if (kissCount === 6 && window.CONFIG.kissMessages[100]) {
        //         showSpecialMessage(window.CONFIG.kissMessages[6]);
        //     }else if (kissCount === 8 && window.CONFIG.kissMessages[100]) {
        //         showSpecialMessage(window.CONFIG.kissMessages[8]);
        //     }else if (kissCount === 10 && window.CONFIG.kissMessages[100]) {
        //         showSpecialMessage(window.CONFIG.kissMessages[10]);
        //     }
        // }
    });
